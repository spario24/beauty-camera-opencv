package com.android.camera.beauty.activity;
...
import com.android.beautyfilter.BeautyEngine;
import com.android.beautyfilter.display.BeautyImageDisplay;
import com.android.camera.beauty.edit.ImageEditFragment;
import com.android.camera.beauty.edit.adjust.ImageEditAdjustView;
import com.android.camera.beauty.edit.beauty.ImageEditBeautyView;
import com.android.camera.beauty.edit.filter.ImageEditFilterView;
...
//                int i = -1;
                ...
                if (checkedId == R.id.image_edit_adjust) {
                    ...
                    if (!mFragments[i].isAdded()) {
                        getFragmentManager().beginTransaction()
                                .add(R.id.image_edit_fragment_container, mFragments[i])
                                .show(mFragments[i])
                                .commit();
                    } else {
                        getFragmentManager().beginTransaction()
